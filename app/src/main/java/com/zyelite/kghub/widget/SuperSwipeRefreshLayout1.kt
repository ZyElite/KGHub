...
class SuperSwipeRefreshLayout1 : ViewGroup, NestedScrollingParent, NestedScrollingChild {
    ...
    private val mRefreshListener = object : Animation.AnimationListener {
        override fun onAnimationStart(animation: Animation) {
            var b = animation == null
            LogUtil.e("onAnimationStart  $b ")
        }

        override fun onAnimationRepeat(animation: Animation) {
            var b = animation == null
            LogUtil.e("onAnimationRepeat  $b ")
        }

        override fun onAnimationEnd(animation: Animation) {
            var b = animation == null
            LogUtil.e("onAnimationEnd  $b ")
            if (mRefreshing) {
...
//                        LogUtil.e("下拉刷新")
    ...
    private fun setRefreshing(refreshing: Boolean, notify: Boolean) {
        if (mRefreshing != refreshing) {
            ...
            mRefreshing = refreshing
            if (mRefreshing) {
                LogUtil.e("Super setRefreshing  走了吗")
